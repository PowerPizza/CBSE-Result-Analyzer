...
DATA_DIRECTORY = os.path.join(os.getenv("APPDATA"), "Result Analyzer 12th v1.0.0")
...
def initDataFrame(dataLinePairs):
    ...
    df_ = DataFrame(
        columns=["roll_no", "student_name", "gender"] + columns_ + ["Max Marks OA", "Total OA", "Percentage OA", "Average OA"] + ["Max Marks B5", "Total B5", "Percentage B5", "Average B5"] + ["result", "compartment"])
